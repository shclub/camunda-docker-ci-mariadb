...
RUN wget -P /tmp/mariadb \
      ftp://camunda-ci1/ci/binaries/mariadb/MariaDB-${MARIADB_VERSION}-centos7-x86_64-client.rpm \
      ftp://camunda-ci1/ci/binaries/mariadb/MariaDB-${MARIADB_VERSION}-centos7-x86_64-common.rpm \
      ftp://camunda-ci1/ci/binaries/mariadb/MariaDB-${MARIADB_VERSION}-centos7-x86_64-server.rpm \
      ftp://camunda-ci1/ci/binaries/mariadb/MariaDB-${MARIADB_VERSION}-centos7-x86_64-shared.rpm && \
